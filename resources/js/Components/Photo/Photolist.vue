<template>
    ...
    <main v-show="!FullImage">
        <v-container>
            ...
            <div>
                <!-- <file-preview-dialog :dialog="showFilePreview" :id="items.length" :photo_id="0"
                    @onReset="showFilePreview = false" /> -->
            </div>
                                ...
                                <v-hover v-slot="{ isHovering, props }">
                                    <v-card :elevation="isHovering ? 4 : 2" v-bind="props">
                                        <div class="image-item" :key="index + '-image-item-' + n"
                                            ...
                                            <v-img :src="n.src_tmb" :lazy-src="n.src_big" cover
                                                class="bg-grey-lighten-2 img-vue" height="220">
                                                ...
                                                <v-toolbar density="compact">
                                                    <div class="d-flex px-2 image-toolbar">
                                                        <v-icon icon="mdi-loupe" @click="showFullImage"
                                                            :data-src="n.src_big" :data-title="n.title"
                                                            :data-descr="n.descr" class="mr-2"></v-icon>
                                                        <v-icon icon="mdi-newspaper-plus"
                                                            @click="showFilePreviewDialog(n.src_tmb)" class="mr-2"></v-icon>
